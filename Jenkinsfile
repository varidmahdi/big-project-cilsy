        ...
        stage('Push Notification') {
            steps {
                script{
                    ...
                    sh '''
                        curl -s -X POST https://api.telegram.org/bot${TOKEN}/sendMessage -d chat_id=${CHAT_ID} -d parse_mode="HTML" -d text="<b>Project</b> : Big Project Cilsy "/n" <b>Branch</b> : $GIT_BRANCH "/n" <b>Deploying</b> : Success"
                        '''
                    }
                }
            }
